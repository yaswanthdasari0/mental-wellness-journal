    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .journal-page-subtext {
          font-size: 0.88rem;
          color: #94a3b8;
          margin-bottom: 1.8rem;
        }

        /* Two-column — editor left, recent entries right */
        .journal-grid {
          display: grid;
        ...
        @media (max-width: 560px) {
          .journal-content { padding: 1.5rem 1.2rem 2.5rem; }
        }
      `}</style>
            ...
            <div className="journal-grid">
              ...
              <div>
                <div className="journal-section-header">
                  <div className="journal-section-heading" style={{ marginBottom: 0 }}>Recent Entries</div>
                  <div className="journal-entry-count">5 entries</div>
                </div>
                <RecentJournals />
              </div>
            </div>
